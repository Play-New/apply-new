...
Current policy: **Claude Code (primary) and opencode (open-source fallback)** — two
sources done properly before more are added. A new source needs a provenance and
